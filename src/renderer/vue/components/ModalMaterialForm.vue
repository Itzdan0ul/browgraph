<template>
  <div class="modal" role="dialog">
    ...
    <div
      class="modal__root"
      :class="{
        'modal__root--material-form': forms.includes('add'),
        'modal__root-material-edit': forms.includes('edit'),
      }"
    >
      ...
      <div class="modal__body">
        <template v-if="forms.includes('add')">
          <ModalMaterialFormAdd />
        </template>
        <template v-if="forms.includes('edit')">
          <ModalMaterialFormEdit />
        </template>
      </div>
    </div>
  </div>
...
<script>
  ...
  import ModalMaterialFormAdd from './ModalMaterialFormAdd.vue';
  import ModalMaterialFormEdit from './ModalMaterialFormEdit.vue';

  export default {
    name: 'ModalMaterialForm',
    components: {
      ModalMaterialFormAdd,
      ModalMaterialFormEdit,
    },
    methods: { ...mapMutations('modal', { renderModal: 'RENDER_MODAL' }) },
    computed: { ...mapState('form', ['forms']) },
  };
</script>
